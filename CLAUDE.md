# Claude Code Operating Rules — Billing Collaboration Platform

This file is the Claude Code and Claude IDE-extension adapter for the repo-local agent harness. Read `AGENTS.md` first; it is the cross-agent source of truth.
...
Claude Code must follow the same Hermes Update Pack cadence as OpenCode:
