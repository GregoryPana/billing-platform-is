...
2. Create the billing cycle 📝
3. Generate test scripts and run them 🧪
4. Track results and request finance approval to move to live 🚦
5. Finance approves (or rejects with comments) ✔️
6. Generate live scripts and run them ⚡
7. Request finance approval that live is complete 🔚
8. Finance approves ✔️
9. Generate notification commands (email + SMS) 📧
10. Confirm completion and review the audit log 📋

---

## Step 1: Sign In to the Platform 🔐

**Where:** Open the billing platform URL and sign in with your credentials.
...
**Where:** Go to **Runs Tracking** ▶️ in the sidebar.
...
![Step 6.1: Review Cycle](/billing/user-guide/review-cycle.png)

![Step 6.2: Approving the Cycle](/billing/user-guide/finance-approvals.png)
...
## Step 7: Configure Request Settings ⚙️

**Where:** Go to **Request Settings** ⚙️ in the sidebar.

![Step 7: Configure Request Settings](/billing/user-guide/request-settings.png)
