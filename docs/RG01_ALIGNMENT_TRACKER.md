...
| Issue 17 | Deployment control | Manual exact-commit production deploy and immutable rollback | implemented locally; not deployed | Secure workflows, scripts, negative tests and `docs/PRODUCTION_DEPLOYMENT.md`; GitHub Environment/host setup and live proof remain operator gates |
